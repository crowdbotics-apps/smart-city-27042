"""smart_city_27042 URL Configuration
...
admin.site.site_title = "Smart city Admin Portal"
admin.site.index_title = "Smart city Admin"

# swagger
api_info = openapi.Info(
    title="Smart city API",
    default_version="v1",
    description="API documentation for Smart city App",
)
